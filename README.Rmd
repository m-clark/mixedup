...
If you have an issue with the installation (something about `rstanarm` and `brms_model`), you can ignore it with the following, as it only regards some internal data used for the vignettes, which is completely unnecessary for the package.
