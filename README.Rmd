...
Just a note, <span class="pack" style = "">nlme</span> has pretty much been superceded by <span class="pack" style = "">glmmTMB</span>, <span class="pack" style = "">brms</span>, and others, so support here is pretty minimal.
...
Extract heterogeneous variances from nlme (and eventually glmmTMB), which only reports the relative standard deviation values by default.
