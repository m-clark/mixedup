...
Provides extended functionality for mixed models. The goal of mixedup is to solve little problems that slip through the cracks from the various packages, broom, and others.  Basically the idea is to create (tidy) objects that are easy to use and mostly ready for presentation, and consistent across packages.
...
extract_random_effects(brm_2, re = 'Subject')
```
