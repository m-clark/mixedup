# Getting help with mixedup

Thanks for using mixedup. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/mixedup/issues) to make sure the 
